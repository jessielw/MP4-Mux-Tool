...
class ContentTabbed(QTabWidget):
    def __init__(self, object_name: str, backend: object, name: str, layout_object_name: str, extensions: list, enable_delay: bool):
        super().__init__()
        ...
        self.name = name
        self.layout_object_name = layout_object_name
    ...
    def _add_new_tab(self):
        ...
        audio_content = LayoutContent(self.backend, self.name, self.layout_object_name, self.extensions, 10, self.enable_delay)
        ...
        new_tab_button.setToolTip("Add new subtitle track")
